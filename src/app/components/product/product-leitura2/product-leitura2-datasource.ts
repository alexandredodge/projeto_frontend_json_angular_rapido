...
const EXAMPLE_DATA: Product[] = [
  ...
  {id: 12, name: 'Magnesium', price:15.99},
...
/**
 * Data source for the ProductLeitura2 view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class ProductLeitura2DataSource extends DataSource<Product> {
